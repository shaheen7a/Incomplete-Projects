...
export const education = [
  {
    ...
    date: "Professional",
    desc: "We’re building the future, one brick at a time. From the commons to the classroom, we create spaces that help students reach their full potential.",
